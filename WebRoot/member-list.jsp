	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<c:forEach items="${cuss}" var="cus">
			<tr class="text-c">
				...
				<td>${cus.phone}</td>
				<td>${cus.email}</td>
				<td class="text-l">${cus.address}</td>
	 ...
	 <a href="/bookstore/login/cutomerList?pagenum=1"  class="btn btn-secondary radius">首页</a>
	 	   <a href="/bookstore/login/cutomerList?pagenum=${previousPage}"  class="btn btn-default radius">上一页</a>
	  <a href="/bookstore/login/cutomerList?pagenum=${nextPage}"  class="btn btn-default radius">下一页</a>
	  <a href="/bookstore/login/cutomerList?pagenum=${lastPage}"  class="btn btn-secondary radius">末页</a>
	</div>
</div>
